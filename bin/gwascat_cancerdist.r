...
DataPublication<-read.csv('gwas-catalog-v1.0.3-studies-r2022-07-09.tsv', sep='\t')
...
write.csv(DataPublicationCancer3, file='cancer_ethnicity.csv',row.names=F)
...
ggsave('dist_cancer_studies_gc.jpeg')
...
ggsave('dist2_cancer_studies_gc.jpeg')
